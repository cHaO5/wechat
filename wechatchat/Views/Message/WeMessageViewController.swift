...
class WeMessageViewController: UIViewController {
    @IBOutlet fileprivate weak var listTableView: UITableView!
    fileprivate var itemDataSouce = [MessageModel]()
    var actionFloatView: WeMessageActionFloatView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "微信"
        self.view.backgroundColor = UIColor.groupTableViewBackground
//        self.navigationItem.rightButtonAction(WeAsset.Barbuttonicon_add.image) { () -> Void in
//            self.actionFloatView.hide(!self.actionFloatView.isHidden)
//        }
        
        //Init ActionFloatView
        self.actionFloatView = WeMessageActionFloatView()
        ...
        //Init listTableView
        self.listTableView.ts_registerCellNib(WeMessageTableViewCell.self)
    ...
    fileprivate func fetchData() {
        ...
        do {
            ...
            for dict in jsonObject["data"].arrayObject! {
                guard let model = WeMapper<MessageModel>().map(JSON: dict as! [String : Any]) else { continue }
...
extension WeMessageViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)
//        let viewController = WeChatViewController.ts_initFromNib() as! WeChatViewController
...
extension WeMessageViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: WeMessageTableViewCell = tableView.ts_dequeueReusableCell(WeMessageTableViewCell.self)
...
extension WeMessageViewController: ActionFloatViewDelegate {
