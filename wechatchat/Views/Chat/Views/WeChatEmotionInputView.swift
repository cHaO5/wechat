...
class WeChatEmotionInputView: UIView {
    ...
    @IBOutlet fileprivate weak var listCollectionView: WeChatEmotionScollView!
    ...
    override func awakeFromNib() {
        ...
        self.listCollectionView.register(WeChatEmotionCell.ts_Nib(), forCellWithReuseIdentifier: WeChatEmotionCell.identifier)
        self.listCollectionView.isPagingEnabled = true
        self.listCollectionView.emotionScrollDelegate = self

        //init dataSource
        guard let emojiArray = NSArray(contentsOfFile: WeConfig.ExpressionPlist!) else {
            return
        }
...
extension WeChatEmotionInputView: UICollectionViewDelegate {
...
extension WeChatEmotionInputView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: WeChatEmotionCell.identifier, for: indexPath) as! WeChatEmotionCell
...
extension WeChatEmotionInputView: UIScrollViewDelegate {
...
extension WeChatEmotionInputView: UIInputViewAudioFeedback {
...
extension WeChatEmotionInputView: ChatEmotionScollViewDelegate {
    func emoticonScrollViewDidTapCell(_ cell: WeChatEmotionCell) {
...
protocol ChatEmotionInputViewDelegate: class {
     ...
     */
    func chatEmoticonInputViewDidTapCell(_ cell: WeChatEmotionCell)
     ...
     */
    func chatEmoticonInputViewDidTapBackspace(_ cell: WeChatEmotionCell)
