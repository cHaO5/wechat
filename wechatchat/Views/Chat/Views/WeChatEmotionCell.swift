...
class WeChatEmotionCell: UICollectionViewCell {
    ...
    func setCellContnet(_ model: EmotionModel? = nil) {
        ...
        self.isDelete = false
        if let path = WeConfig.ExpressionBundle!.path(forResource: model.imageString, ofType:"png") {
    ...
    func setDeleteCellContnet() {
        self.emotionModel = nil
        self.isDelete = true
        self.emotionImageView.image = WeAsset.Emotion_delete.image
    }
